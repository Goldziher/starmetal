...
use depot_core::publishing::{PublishRequest, PublishedArtifact, YankRequest};
...
impl DepotRuntime {
    ...
    pub async fn versions(
        ...
        ecosystem: Ecosystem,
        name: &str,
    ) -> Result<Vec<depot_core::package::VersionInfo>> {
    ...
    ) -> Result<depot_core::publishing::PublishResult> {
...
mod tests {
    ...
    async fn publish_artifact_stores_metadata() {
        ...
        let runtime = DepotRuntime::from_config(config)
            .await
